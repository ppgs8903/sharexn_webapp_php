...
<html lang="zh-CN"><head>
    ...
    <body background="2008319183523380_2.jpg">
                        ...
                        <div class="panel-body">
                            <form>
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <label for="exampleInputFile">记住登录</label>
                                </div>
                            </form>
                            <div class="text-center">
                               <button class="btn btn-default" id="login">登录</button>
                               <button class="btn btn-default" id="singleup">注册</button>
                            </div>
                        </div>
                    </div><!--/. END PANL -->
                </div><!--/. row end -->
...
<script type="text/javascript" src="/Public/js/sharexn/login.js"></script>
